...
if (window.location.toString().includes("liveMiddleware")) {
  $.ajax({
    ...
    success: function (resp) {
      if (resp.liveLessonInfo.studyTime == null) alert("aktif canlÄ± ders yok");
      else {
        if (resp.liveLessonInfo.studyTime.registrantJoinUrl) {
          ...
          $.ajax({
            ...
            success: function (resp2) {
              ...
              $.ajax({
                url:
                  "https://cezeri.software/sebit.php?nonce=" +
                  resp2.meeting.token,
    ...
    success: function (resp) {
      ...
      $.ajax({
        ...
        success: function (resp2) {
          ...
          $.ajax({
            url:
              "https://cezeri.software/sebit.php?nonce=" + resp2.meeting.token,
            success: function (resp3) {
              try {
                ga("send", "event", {
                  eventCategory: "liveLesson",
